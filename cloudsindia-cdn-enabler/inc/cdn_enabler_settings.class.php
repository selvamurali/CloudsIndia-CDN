...
class CDN_Enabler_Settings
{
    ...
    public static function settings_page()
    {
      ...
      ?>
        <div class="wrap">
           <h2>
               <?php _e("CDN Enabler Settings", "clouds-cdn-enabler"); ?>
           </h2>
		   ...
		   </div>'), 'https://www.cloudsindia.in?utm_source=wp-admin&utm_medium=plugins&utm_campaign=clouds-cdn-enabler', 'CloudsIndia');
                }
            ?>
           ...
           <form method="post" action="options.php">
               ...
               <table class="form-table">
                   ...
                   <tr valign="top">
                       <th scope="row">
                           <?php _e("CDN URL", "clouds-cdn-enabler"); ?>
                       </th>
                       <td>
                           <fieldset>
                               ...
                               <p class="description">
                                   <?php _e("Enter the CDN URL without trailing", "clouds-cdn-enabler"); ?> <code>/</code>
                               </p>
                           </fieldset>
                       </td>
                   </tr>
                   ...
                   <tr valign="top">
                       <th scope="row">
                           <?php _e("Included Directories", "clouds-cdn-enabler"); ?>
                       </th>
                       <td>
                           <fieldset>
                               <label for="cdn_enabler_dirs">
                                   ...
                                   <?php _e("Default: <code>wp-content,wp-includes</code>", "clouds-cdn-enabler"); ?>
                               </label>

                               <p class="description">
                                   <?php _e("Assets in these directories will be pointed to the CDN URL. Enter the directories separated by", "clouds-cdn-enabler"); ?> <code>,</code>
                               </p>
                           </fieldset>
                       </td>
                   </tr>
                   ...
                   <tr valign="top">
                       <th scope="row">
                           <?php _e("Exclusions", "clouds-cdn-enabler"); ?>
                       </th>
                       <td>
                           <fieldset>
                               <label for="cdn_enabler_excludes">
                                   ...
                                   <?php _e("Default: <code>.php</code>", "clouds-cdn-enabler"); ?>
                               </label>

                               <p class="description">
                                   <?php _e("Enter the exclusions (directories or extensions) separated by", "clouds-cdn-enabler"); ?> <code>,</code>
                               </p>
                           </fieldset>
                       </td>
                   </tr>
                   ...
                   <tr valign="top">
                       <th scope="row">
                           <?php _e("Relative Path", "clouds-cdn-enabler"); ?>
                       </th>
                       <td>
                           <fieldset>
                               <label for="cdn_enabler_relative">
                                   ...
                                   <?php _e("Enable CDN for relative paths (default: enabled).", "clouds-cdn-enabler"); ?>
                               </label>
                           </fieldset>
                       </td>
                   </tr>
                   ...
                   <tr valign="top">
                       <th scope="row">
                           <?php _e("CDN HTTPS", "clouds-cdn-enabler"); ?>
                       </th>
                       <td>
                           <fieldset>
                               <label for="cdn_enabler_https">
                                   ...
                                   <?php _e("Enable CDN for HTTPS connections (default: disabled).", "clouds-cdn-enabler"); ?>
                               </label>
                           </fieldset>
                       </td>
                   </tr>
